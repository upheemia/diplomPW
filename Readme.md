...
Для доступа в Jenkins необходима регистрация на ресурсе [Jenkins](https://jenkins.autotests.cloud/). Для запуска сборки необходимо перейти [по ссылке](https://jenkins.autotests.cloud/job/pw-js-test/) и нажать кнопку <code>Build Now</code>.
<p align="center">
